...
const search = async (query) =>
  ...
  axios.get(`https://api.themoviedb.org/3/trending/all/day?api_key=b508e614477c137da7c8dc95579b02ac`);
...
export default { search, trendingMovies, inTheaters,trendingToday };
